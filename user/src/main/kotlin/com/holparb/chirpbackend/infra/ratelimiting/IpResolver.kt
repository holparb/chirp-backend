package com.holparb.chirpbackend.infra.ratelimiting

import com.holparb.chirpbackend.infra.config.NginxConfig
...
class IpResolver(
    ...
    companion object {
        ...
        private const val HEADER = "X-Real-IP"
    }
    ...
    private fun extractFromXRealIp(
        ...
        return request.getHeader(HEADER)?.let { header ->
            validateAndNormalizeIp(header, HEADER, proxyIp)
        }
    }
